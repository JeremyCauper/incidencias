...
namespace App\Http\Controllers\Soporte\Turno;
...
class TurnoController extends Controller
{
    public function view()
    {
        ...
        try {
            ...
            $data['usuarios'] = DB::table('tb_personal')->where(['estatus' => 1, 'eliminado' => 0, 'id_area' => 1])->get()->keyBy('id_usuario')->map(function ($u) {
            ...
            return view('soporte.turno.turno', ['data' => $data]);
        } catch (Exception $e) {
