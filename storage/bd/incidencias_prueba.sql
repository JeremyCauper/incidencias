...
-- ----------------------------
INSERT INTO `tb_empresas` VALUES (1, '20345774042', 'SERVICENTRO AGUKI S.A.', 0, 115, 3, 'AV. ELMER FAUCETT 5482', 0x313530313430, 1, 1, 'Freddy Taira', NULL, '946501508', 'ftaira@aguki.com', 1, 0, 0, 0, 0, 1, '2025-01-06 09:45:58', '2024-12-30 11:22:03');
...
CREATE TABLE `tb_incidencias`  (
  ...
  `observasion` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL,
  ...
  INDEX `FK_Empresa`(`id_empresa`) USING BTREE,
  INDEX `FK_Sucursal`(`id_sucursal`) USING BTREE,
  CONSTRAINT `FK_Empresa` FOREIGN KEY (`id_empresa`) REFERENCES `tb_empresas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Problema` FOREIGN KEY (`id_problema`) REFERENCES `tb_problema` (`id_problema`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Sub_Problema` FOREIGN KEY (`id_subproblema`) REFERENCES `tb_subproblema` (`id_subproblema`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Sucursal` FOREIGN KEY (`id_sucursal`) REFERENCES `tb_sucursales` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Tipo_Estacion` FOREIGN KEY (`id_tipo_estacion`) REFERENCES `tb_tipo_estacion` (`id_tipo_estacion`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Tipo_Incidendia` FOREIGN KEY (`id_tipo_incidencia`) REFERENCES `tb_tipo_incidencia` (`id_tipo_incidencia`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Tipo_Soporte` FOREIGN KEY (`id_tipo_soporte`) REFERENCES `tb_tipo_soporte` (`id_tipo_soporte`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- ----------------------------
INSERT INTO `tb_incidencias` VALUES (1, 'INC-00000001', 103, 17, 1, 'Alta', 1, 2, 1, 1, NULL, 'urgente', '2024-12-30', '15:43:37', 3, 1, 1, NULL, '2024-12-30 15:45:57');
INSERT INTO `tb_incidencias` VALUES (2, 'INC-00000002', 1, 132, 1, 'Alta', 1, 2, 3, 35, 5, 'mega urgente', '2024-12-30', '15:47:24', 2, 1, 0, NULL, '2024-12-30 15:50:09');
INSERT INTO `tb_incidencias` VALUES (3, 'INC-00000003', 103, 18, 1, 'Media', 1, 2, 9, 88, NULL, 'super urgente', '2024-12-30', '15:52:17', 3, 1, 1, NULL, '2024-12-30 15:52:59');
INSERT INTO `tb_incidencias` VALUES (4, 'INC-00000004', 3, 209, 1, 'Alta', 3, 2, 1, 1, NULL, 'urgentisimo', '2024-12-30', '16:13:31', 3, 1, 1, NULL, '2024-12-30 16:13:57');
INSERT INTO `tb_incidencias` VALUES (5, 'INC-00000005', 103, 18, 1, 'Alta', 1, 1, 7, 76, NULL, NULL, '2025-01-06', '17:51:34', 3, 1, 1, NULL, '2025-01-06 17:57:28');
...
INSERT INTO `tb_incidencias` VALUES (13, 'INC-00000013', 1, 132, 1, 'Alta', 1, 2, 2, 20, 8, NULL, '2025-02-02', '18:38:24', 1, 1, 1, '2025-02-02 18:39:06', '2025-02-02 17:39:02');
...
INSERT INTO `tb_submenu` VALUES (4, 4, 'Grupos Empresas', 'Lol', '/empresas/grupos', 0, 1, '2025-02-05 11:59:39', '2025-02-01 20:13:05');
...
INSERT INTO `tb_submenu` VALUES (9, 6, 'Menu', 'Config. Menu', '/mantenimiento/menu/menu', 0, 1, NULL, '2025-02-01 20:18:53');
INSERT INTO `tb_submenu` VALUES (10, 6, 'Sub Menu', 'Config. Menu', '/mantenimiento/menu/submenu', 0, 1, NULL, '2025-02-01 20:19:18');
...
-- ----------------------------
INSERT INTO `tb_vis_asignadas` VALUES (2, 3, 3, 1, '2025-01-07', '14:21:40', '2025-01-07 14:21:40');
INSERT INTO `tb_vis_asignadas` VALUES (3, 5, 4, 1, '2025-01-17', '16:50:53', '2025-01-17 16:50:53');
...
-- ----------------------------
INSERT INTO `tipo_usuario` VALUES (1, 'Gerencia', 1);
INSERT INTO `tipo_usuario` VALUES (2, 'Administrativo', 1);
INSERT INTO `tipo_usuario` VALUES (3, 'Tecnico', 1);
INSERT INTO `tipo_usuario` VALUES (4, 'Personalido', 1);
...
CREATE TABLE `usuarios`  (
  ...
  UNIQUE INDEX `Dni`(`ndoc_usuario`) USING BTREE,
  UNIQUE INDEX `Usu`(`usuario`) USING BTREE,
  UNIQUE INDEX `Pas`(`contrasena`) USING BTREE,
  UNIQUE INDEX `ePer`(`email_personal`) USING BTREE,
  UNIQUE INDEX `eCor`(`email_corporativo`) USING BTREE,
  UNIQUE INDEX `tPer`(`tel_personal`) USING BTREE,
  UNIQUE INDEX `tCor`(`tel_corporativo`) USING BTREE,
...
-- Records of usuarios
-- ----------------------------
INSERT INTO `usuarios` VALUES (1, '61505130', 'JEREMY PATRICK', 'CAUPER SILVANO', 'jcauper@gmail.com', 'jcauper@email.com', '2025-02-03 16:02:06', '2003-07-14', '974562354', '954213548', 'jcauper', '$2y$12$tJ1uh20FxN8cWtY8ofWZK.YXJe1d7nVLguPUQxGCEBxzuf8FN.pPG', '123456', 'user_auth.jpg', 'fd_jcauper.png', 2, 1, 'eyIxIjpbXSwiMiI6W10sIjMiOlsiMSIsIjIiXSwiNCI6WyIzIiwiNCIsIjUiXSwiNSI6WyI2Il19', NULL, 0, 1, '2025-02-03 16:02:04', '2024-07-09 23:00:19');
INSERT INTO `usuarios` VALUES (3, '12345678', 'Pedro', 'Suarez', 'psuarez@gmail.com', 'psuarez@email.com', '2025-02-05 15:08:13', '2003-01-14', '935423118', '952332137', 'psuarez', '$2y$12$dkCCpmvLxzmTkW6OxpZCK.AvBqFpDUVWb90K5EDReDCJ0e3zjeZ5q', '123789', 'fp_psuarez.png', 'fd_psuarez.png', 3, 3, 'eyIyIjpbXX0=', NULL, 0, 1, '2025-02-05 15:08:11', '2024-07-13 02:41:10');
INSERT INTO `usuarios` VALUES (4, '74716278', 'JOSTHEIN JOSEPH', 'MAYORCA BELLEZA', 'jmayorca@gmail.com', 'jmayorca@email.com', '2025-02-03 14:57:22', '1997-06-11', '978456123', '985267341', 'jmayorca', '$2y$12$XtbOLsPsbk.46I9bhAX2geOJfE7CiCp4YZqweagUQgCbSaUmCHArS', '147852', 'user_auth.jpg', 'fd_jmayorca.png', 3, 1, 'eyIxIjpbXSwiMiI6W119', NULL, 0, 1, '2025-01-28 21:38:10', '2024-07-15 22:18:33');
INSERT INTO `usuarios` VALUES (5, '70401296', 'BRYAN MARTIN', 'POLO GOMEZ', 'talvan@gmail.com', 'talvan@email.com', '2025-02-03 14:57:22', '2001-07-02', '987564123', '948741236', 'talvan', '$2y$12$h7PwBsMN0k3/57Y3QarvIuHuU1kODsnWbK/zASZz32rY7MYQELKxm', '987654', 'user_auth.jpg', 'fd_talvan.png', 3, 1, 'eyIxIjpbXSwiMiI6W119', NULL, 0, 1, '2025-01-28 21:40:55', '2024-07-22 02:16:27');
