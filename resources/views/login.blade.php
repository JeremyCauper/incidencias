...
<body class="d-flex" style="min-height: 100vh;">
    <div class="col-7 position-relative overflow-hidden bg-gradient-to-br from-slate-900 to-slate-900 via-slate-800">
        <div class="position-absolute" style="inset: calc(.25rem * 0);">
            <img src="https://images.unsplash.com/photo-1770200395451-58bbe896a57b?crop=entropy&amp;cs=tinysrgb&amp;fit=max&amp;fm=jpg&amp;ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBvZmZpY2UlMjB0ZWNobm9sb2d5JTIwd29ya3NwYWNlfGVufDF8fHx8MTc3MDY1NTYyMXww&amp;ixlib=rb-4.1.0&amp;q=80&amp;w=1080"
                alt="Modern workspace" class="w-100"
                style="opacity: .2; object-fit: cover;height: 100vh;filter: blur(2px);">
        </div>
        <div class="d-flex flex-column justify-content-between p-5 position-relative text-white"
            ...
            <div style="opacity: 1; transform: none;">
                <div class="d-flex align-items-center gap-3 mb-5">
                    <img src="{{ secure_asset('../public/front/images/app/LogoRC_WBlanco.webp') }}" style="height: 5rem;">
                </div>
            </div>
    ...
    <div class="col-5 justify-content-center p-5 bg-white">
        <div>
            ...
            <div style="opacity: 1; transform: none;">
                <div class="mb-4">
                    ...
                    <p class="mb-0" style="color: oklch(.446 .043 257.281);">Accede al portal de gestión de incidencias
                    </p>
                </div>
                <div class="mb-4">
                    <div class="rounded p-2 d-flex gap-2" style="background-color: oklch(.968 .007 247.896);">
                        <button class="border-0 col d-flex gap-2 justify-content-center py-2 rounded" style="color: oklch(.279 .041 260.031);font-size: .75rem;">
                        ...
                        <button class="border-0 col d-flex gap-2 justify-content-center py-2 rounded active" style="color: oklch(.279 .041 260.031);font-size: .75rem;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <div style="opacity: 1; transform: none;">
                        <div>
                            ...
                            <div>
                                ...
                                <p>Portal para empresas y usuarios que reportan incidencias</p>
                            </div>
                        </div>
                    </div>
                </div>
                <form class="space-y-5">
                    <div>
                        ...
                        <div>
                            ...
                            </svg><input type="email" placeholder="cliente@empresa.com" required="">
                        </div>
                    </div>
                    <div>
                    ...
                    <button type="submit" tabindex="0" style="transform: none;">Iniciar Sesión</button>
                </form>
                <div>
                    <div>
                        <div></div>
                    </div>
                    <div><span>Información de acceso</span></div>
                </div>
                <div>
                    ...
                    <p>Para obtener acceso al portal de cliente, contacta con el equipo de atención al cliente.</p>
                </div>
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                    ...
                    </svg><span>Conexión cifrada SSL/TLS 256-bit</span>
                </div>
            </div>
        </div>
    </div>
