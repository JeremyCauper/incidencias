                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <div class="dropdown">
                        <a data-mdb-dropdown-init
                            ...
                            <img class="img-xs rounded-circle" src="{{ config('ajustes.config')->foto_perfil }}"
                                alt="Profile image">
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuAvatar">
                            <li>
                                <span class="dropdown-header text-center">
                                    <img class="img-md rounded-circle" src="{{ config('ajustes.config')->foto_perfil }}"
                                        alt="Profile image" style="width: 90px; height: 90px;">
                                    <p class="mb-1 mt-3 fw-semibold">
                                        {{ config('ajustes.config')->nombre_perfil }}
                                    </p>
                                    <p>{{ config('ajustes.config')->acceso }}</p>
                                </span>
                            </li>
                            <li>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item menu-item text-center" tittle-menu>
                        <div class="nav-link menu-perfil pt-0">
                            <img class="rounded-circle" src="{{ config('ajustes.config')->foto_perfil }}">
                            <span class="ms-2 menu-title">
                                <p class="fw-bold mb-1 nombre-personal">{{ config('ajustes.config')->nombre_perfil }}
                                </p>
                                <p class="text-muted mb-0 tipo-personal">{{ config('ajustes.config')->acceso }}
                                </p>
                            </span>
                        </div>
                    </li>
