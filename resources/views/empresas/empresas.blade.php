        ...
        <form class="modal-content" id="form-empresa">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-5 mb-2 required">
                        <label class="form-label mb-0" for="ruc">Ruc</label>
                        <input type="text" class="form-control" id="ruc" name="ruc" require="Ruc">
                    </div>
                    <div class="col-lg-5 col-12 mb-2 required">
                    ...
                    <div class="col-lg-3 col-6 mb-2 required">
                    ...
                    <div class="col-lg-2 col-4 mb-2 required">
