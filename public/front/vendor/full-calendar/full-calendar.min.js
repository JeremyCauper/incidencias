...
var FullCalendar = function(e) {
    ...
    class en {
        constructor(e) {
            ...
            for (let i in e)
                i in qt ? (n[i] = e[i],
                r = Math.max(qt[i], r)) : (t[i] = e[i],
                i in Yt && (r = Math.max(Yt[i], r)));
    ...
    function qr(e, t) {
        return Cr(function(e) {
            ...
            return t = t.map(e => Object.assign(Object.assign({}, Qr), e)),
            t
        }(e), null, t)
    }
    function Yr(e, t, n) {
    ...
    class ki extends Gn {
        ...
        render() {
            ...
            return Ti() || s.push("fc-liquid-hack"),
            e.children(s, i, r, n)
        }
        componentDidMount() {
    ...
    class _s extends Gn {
        constructor() {
            super(...arguments),
            this.createDayHeaderFormatter = Gt(Ts)
        }
        render() {
            let {context: e} = this
        ...
        return !(e.eventDrag && !function(e, t, n, r) {
            ...
            for (let r in l) {
                ...
                for (let e of p.allows) {
                    ...
                    if (i = a ? new ti(t,a,l) : new ti(t,m),
                    !e(Zr(s, t), i))
                        return !1
                }
            }
            ...
            r && (c = r(c));
            if (!js(c.constraints, l, i, e.businessHours, t))
                return !1;
    ...
    function Do(e) {
        ...
        return {
            ...
            n.reduce(Ro).eventRange.range.end)
        };
        var n
    }
    function wo(e) {
    ...
    class _a extends Vn {
        ...
        render() {
            let e, {props: t} = this, {toolbarConfig: n, options: r} = t, i = this.buildToolbarProps(t.viewSpec, t.dateProfile, t.dateProfileGenerator, t.currentDate, fr(t.options.now, t.dateEnv), t.viewTitle), s = !1, o = "";
    ...
    class Va {
        ...
        isWithinClipping(e, t) {
            ...
            for (let e of this.scrollCaches)
                if (!Ga(e.getEventTarget()) && !Pi(n, e.clientRect))
                    return !1;
            return !0
        }
    }
        ...
        constructor(e) {
            ...
            this.handleHitUpdate = (e, t) => {
                ...
                if (e) {
                    ...
                    o && (a = $r(n, s.getCurrentData().eventUiBases, o, s),
                    c.mutatedEvents = a,
                    Ns(c, e.dateProfile, s) || (l = !0,
                    o = null,
                    a = null,
                    c.mutatedEvents = {
                        defs: {},
    ...
    var el = Po({
        ...
        , class extends Mi {
            constructor(e) {
                ...
                ,
                this.handlePointerUp = e => {
                    this.dragSelection && (Yr(this.dragSelection, e, this.component.context),
                    this.dragSelection = null)
                }
                ;
                let {component: t} = e
        ...
        , Za, class extends Mi {
            constructor(e) {
                ...
                this.handleHitUpdate = (e, t, n) => {
                    ...
                    a && (l = $r(i, r.getCurrentData().eventUiBases, a, r),
                    d.mutatedEvents = l,
                    Ns(d, e.dateProfile, r) || (c = !0,
                    a = null,
                    l = null,
        ...
        render() {
            ...
            return p(so, Object.assign({}, e, {
                ...
                if (!1 !== s.displayEventTime) {
                    ...
                    if (a.allDay ? c = !0 : ur(e.eventRange.range) ? e.isStart ? o = pi(e, t, n, null, null, l.range.start, e.end) : e.isEnd ? o = pi(e, t, n, null, null, e.start, l.range.end) : c = !0 : o = pi(e, t, n),
                    c) {
                        let e = {
