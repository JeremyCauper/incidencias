...
!function (t, e) {
    ...
    var a = function (a, i, s) {
        if (this.parentEl = "body",
            ...
            "string" == typeof (i = e.extend(this.element.data(), i)).template || i.template instanceof e || (i.template = '<div class="daterangepicker"><div class="ranges"></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-buttons"><span class="drp-selected"></span><div class="drp-content-button"><button class="cancelBtn" type="button"></button><button class="applyBtn" disabled="disabled" type="button"></button></div></div>'),
            this.parentEl = i.parentEl && e(i.parentEl).length ? e(i.parentEl) : e(this.parentEl),
            this.containerDateRange = e('<div class="content-daterangepicker"></div>').appendTo(this.parentEl),
            this.container = e(i.template).appendTo(this.containerDateRange),
    ...
    return a.prototype = {
        ...
        show: function (t) {
            this.isShowing || (this._outsideClickProxy = e.proxy((function (t) {
                ...
                this.previousRightTime = this.endDate.clone(),
                this.updateView(),
                this.containerDateRange.fadeIn(200),
        ...
        hide: function (t) {
            setTimeout(() => {
                this.isShowing && (this.endDate || (this.startDate = this.oldStartDate.clone(),
                    ...
                    this.containerDateRange.fadeOut(350),
