...
!function(n) {
    ...
    function _t(t) {
        for (var e, n, a, r, o, i, l, s = t.oClasses, u = P(t.nTable), u = P("<div/>").insertBefore(u), c = t.oFeatures, f = P("<div/>", {
            ...
            class: s.sWrapper + " mx-3 " + (t.nTFoot ? "" : " " + s.sNoFooter)
        }), d = (t.nHolding = u[0],
        t.nTableWrapper = f[0],
    ...
    function Lt(n) {
        ...
        var t = n.oClasses
          ...
          , o = n.oPreviousSearch
          , i = n.aanFeatures
          , l = '<input type="search" class="form-control"/>'
    ...
    function Gt(a) {
        ...
        var c = P('<div><label style="display: flex;align-items: center;"></label></div>').addClass(t.sLength);
        return a.aanFeatures.l || (c[0].id = e + "_length"),
        c.children().append(a.oLanguage.sLengthMenu.replace("_MENU_", `<span style="margin: 0 5px;font-size: .8rem;">${l[0].outerHTML}</span>`)),
    ...
    function Zt(t) {
        return P("<div/>", {
            ...
            role: "status"
        }).html(t.oLanguage.sProcessing).append('<div class="dt_processing"></div>').insertBefore(t.nTable)[0]
    }
    function D(t, e) {
    ...
    function Qt(n) {
        ...
        // h[0].style.width = M(R + (y ? (l - 3) : 0)), // Modificado => original: h[0].style.width = M(R),
        h[0].style.width = M(R),
        // p.width = M(R + (y ? (l - 3) : 0)), // Modificado => original: p.width = M(R),
        p.width = M(R),
        p[i = "padding" + (T.bScrollbarLeft ? "Left" : "Right")] = y ? l + "px" : "px", // Modificado
    ...
    var te = /<.*?>/g;
    function ee(t) {
        var e, n, a = t.nTable, r = t.aoColumns, o = t.oScroll, i = o.sY, l = o.sX, o = o.sXInner, s = r.length, u = it(t, "bVisible"), c = P("th", t.nTHead), f = a.getAttribute("width"), d = a.parentNode, h = !1, p = t.oBrowser, g = p.bScrollOversize, b = a.style.width, m = (b && -1 !== b.indexOf("%") && (f = b),
        ae(N(r, "sWidthOrig"), d));
        for (_ = 0; _ < u.length; _++)
            null !== (e = r[u[_]]).sWidth && (e.sWidth = m[_],
            h = !0);
        if (g || !h && !l && !i && s == T(t) && s == c.length)
            ...
            _ = 0; _ < u.length; _++)
                ...
                e.sWidthOrig && l && P(c[_]).append(P("<div/>").css({
                    width: e.sWidthOrig,
                    margin: 0,
                    padding: 0,
                    border: 0,
            ...
            for (var y = P("<div/>").css(l || i ? {
                ...
                right: 0,
                overflow: "hidden"
            } : {}).append(b).appendTo(d), D = (l && o ? b.width(o) : l ? (b.css("width", "auto"),
            b.removeAttr("width"),
    ...
    function ae(t, e) {
        for (var n = [], a = [], r = 0; r < t.length; r++)
            t[r] ? n.push(P("<div/>").css("width", M(t[r])).appendTo(e || v.body)) : n.push(null);
    ...
    w.factory = function(t, e) {
        var n = !1;
        return t && t.document && (v = (j = t).document),
    ...
    w.defaults = {
        ...
        oLanguage: {
            oAria: {
                ...
                sSortDescending: ": activar para ordenar columnas descendentes"
            },
            oPaginate: {
                sFirst: '<i class="fas fa-angles-left" style="min-width: .5em;"></i>',
                sLast: '<i class="fas fa-angles-right" style="min-width: .5em;"></i>',
                sNext: '<i class="fas fa-angle-right" style="min-width: .5em;"></i>',
                sPrevious: '<i class="fas fa-angle-left" style="min-width: .5em;"></i>'
            },
