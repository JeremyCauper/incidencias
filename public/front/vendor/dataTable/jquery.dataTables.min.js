...
!function(n) {
    ...
    function Gt(a) {
        ...
        c.children().append(a.oLanguage.sLengthMenu.replace("_MENU_", `<span style="margin: 0 5px;">${l[0].outerHTML}</span>`)),
    ...
    function Zt(t) {
        return P("<div/>", {
            ...
            role: "status"
        }).html(t.oLanguage.sProcessing).append('<div class="dot-opacity-loader"><span></span><span></span><span></span></div>').insertBefore(t.nTable)[0]
    }
    function D(t, e) {
