        ...
        return function () {
            ...
            class w extends x.A {
                ...
                static create(t) {
                    ...
                    return e.setAttribute("href", this.sanitize(t)),
                        ...
                        e.setAttribute("data-id", nameWithoutExt),
                        e
                }
                static formats(t) {
            ...
            class R extends s.EmbedBlot {
                ...
                static create(t) {
                    ...
                    return "string" == typeof t && e.setAttribute("src", this.sanitize(t)), e.setAttribute("data-id", nameWithoutExt),
                        e
                }
                static formats(t) {
            ...
            class ot extends F.A {
                constructor(t, e) {
                    ...
                    this.container instanceof HTMLElement ? (this.container.classList.add("ql-toolbar"),
                        this.container.setAttribute("data-quill-toolbar", t.container.id),
                        this.controls = [],
                        this.handlers = {},
