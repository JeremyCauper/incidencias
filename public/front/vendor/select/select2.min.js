            ...
            e.define("select2/i18n/en", [], function () {
                return {
                    ...
                    inputTooShort: function (e) {
                        return "Por favor ingrese " + (e.minimum - e.input.length) + " o más caracteres"
                    },
                    ...
                    setup: function () {
                        if (this.addEventListener)
                            for (var e = t.length; e;)
                                this.addEventListener(t[--e], i, { passive: true });
                        else
                            this.onmousewheel = i;
