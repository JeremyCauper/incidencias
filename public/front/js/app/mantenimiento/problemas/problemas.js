...
document.getElementById('form-problema').addEventListener('submit', function (event) {
    ...
    $.ajax({
        type: 'POST',
        url: `${__url}/mantenimiento/problemas/problemas/${url}`,
...
function Editar(id) {
    try {
        ...
        $.ajax({
            type: 'GET',
            url: `${__url}/mantenimiento/problemas/problemas/${id}`,
            contentType: 'application/json',
            success: function (data) {
...
async function CambiarEstado(id, estado) {
    try {
        ...
        $.ajax({
            type: 'POST',
            url: `${__url}/mantenimiento/problemas/problemas/cambiarEstado`,
            contentType: 'application/json',
            headers: {
                'X-CSRF-TOKEN': __token,
            },
