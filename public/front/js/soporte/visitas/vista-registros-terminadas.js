...
let cabecera_terminadas = $('<div>', { class: 'col-12 d-flex align-items-center justify-content-between my-3' })
    .append(
        $('<h6>', { class: 'card-title text-primary mb-0' }).append($('<strong>').text('Visitas Terminadas')),
        acciones
    );

if (esCelular()) {
    contenedor_registros.append(cabecera_terminadas, $('<div>', { id: 'listado_vterminadas' }));
